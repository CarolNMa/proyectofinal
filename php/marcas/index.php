...
<body class="body">
    ...
    <div class="container my-5 ">
        <div class="w-100 d-flex justify-content-center opacity-75">
           <h2 class="text-center p-6 mb-1 bg-secondary text-white  w-25 m-20 ">MARCAS</h2>
        </div>
        <a class="btn btn-success" href="../marcas/create.php" role="button">Nueva Marca</a>
        <br>
       
        <div>
            <img src="../emoji/imagenes/emoji.jpg"  class="imagen" alt=""> 
        </div> 
        ...
        <table class="table opacity-75 , border border-secondary" >
                   ...
                   include("../conexion.php");
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-primary btn-sm' href='../marcas/edit.php?id=$row[idMarca]'>Editar</a>
                                <a class='btn btn-danger btn-sm' onclick='confirmAction($row[idMarca])'>Eliminar</a>
            ...
            <script>
                ...
                function confirmAction(idMarca){
                    var result = confirm("¿Estás seguro de que quieres ejecutar esta acción?");
                    if (result) {
                        location.href = "../marcas/delete.php?id=" + idMarca;
                    }
                }
            </script>
        </table>
