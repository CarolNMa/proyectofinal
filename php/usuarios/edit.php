<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        $name = $row["usuaAdmin"];
        $password = $row["passAdmin"];
        $email = $row["correoAdmin"];
    }
    else {
        ...
        do {
            ...
            $sql = "UPDATE usuario " .
                   "SET usuaAdmin = '$name', passAdmin = '$password', correoAdmin = '$email'" . 
                   "WHERE idAdmin = $id";
...
<body>
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label text-light text-center   ">Contraseña</label>
                <div class="col-sm-6">
                    <input type="password" class="form-control" name="password" value="<?php echo $password; ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label text-light text-center">Email</label>
                <div class="col-sm-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="../usuarios/index.php" role="button">Cancelar</a>
                </div>
            </div>
        </form>
    </div>
